  ...
  return (
    ...
    >
      <div className="mt-30 mb-5 ml-30 flex w-170 flex-col mobile:m-0  mobile:w-full mobile:relative mobile:items-center ">
        <h1 className="font-caveat mt-10 text-8xl font-bold mobile:text-5xl mobile:w-70 mobile:order-2 mobile:mt-2 mobile:text-center">
        ...
        <img
          className="absolute right-0 z-[-10] mt-[-140px] h-150 w-250 transition duration-500 peer-hover:scale-110 mobile:w-140 mobile:h-90 mobile:m-0 mobile:object-contain mobile:static mobile:order-1 mobile:mx-auto"
