...
function Blog() {
  return (
    <section
        id="blog"
        className="mt-25 flex w-full flex-col items-center pt-20 mobile:pt-16 mobile:mt-0"
      >
        <div className="flex flex-col items-center">
          <p className="heading">Our Blog</p>
          <p className="font-oswald w-67 text-center mobile:text-sm mobile:w-55">
        ...
        <div className="mt-10 flex w-270 mobile:w-full mobile:flex-col mobile:items-center mobile:gap-y-10 tablet:w-full tablet:px-6">
          <div className="blog-div hover-action h-100 w-80 transition mobile:w-70 mobile:h-92">
            ...
            <p className="font-roboto mt-4 ml-4 w-70 mobile:w-fit mobile:text-sm">
          ...
          <div className="blog-div hover-action h-100 w-80 transition  mobile:w-70 mobile:h-92">
            <div className="h-50 w-full overflow-hidden rounded-3xl bg-red-200 mobile:h-46">
