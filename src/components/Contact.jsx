...
function Contact() {
  return (
      <section id="contact" className="mt-30 flex flex-col items-center pb-10 mobile:mt-10 mobile:pb-12 mobile:pt-14">
        <div>
        ...
        <div className="mt-15 flex items-center mobile:mt-6 mobile:flex-col">
          <div className="font-oswald mr-13 grid grid-cols-[30%_70%] items-center gap-y-7 mobile:mr-0 mobile:grid-cols-[23%_80%]">
          ...
          <iframe
            className="h-100 w-150 mobile:w-90 mobile:h-50 mobile:mt-6"
